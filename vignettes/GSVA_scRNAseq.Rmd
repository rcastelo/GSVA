...
`gsvaColRanks()`, a given column (cell) in the input single-cell data, and a given
...
```{r gsvaenrichment, echo=TRUE, fig.height=5, fig.width=5, out.width="600px", fig.cap="GSVA enrichment plot of the MONOCYTES gene set in the expression profile of the first cell annotated to that cell type."}
...
```{r}
edat <- gsvaEnrichment(gsvacolranks, column=firstmonocytecell,
...
are due to the nonzero values in gene sets that are tied in rankings
